...
public class RealTimeExposureRequest {
    ...
    public static class Builder {
        public static RealTimeExposureRequest fromDelimitedString(String input) {
            ...
            RealTimeExposureRequest req = new RealTimeExposureRequest();
